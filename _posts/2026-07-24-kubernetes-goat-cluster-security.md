...
<p align="center"><img src="/assets/img/kubernetes-goat/diagram-1-container-vs-vm.png" alt="컨테이너는 호스트 커널을 공유한다 — VM과 달리 격리가 약해, 커널 설정이 잘못되면 벽이 무너진다"></p>
...
<p align="center"><img src="/assets/img/kubernetes-goat/diagram-2-k8s-architecture.png" alt="쿠버네티스 아키텍처 — 컨트롤플레인(apiserver·etcd)과 노드(kubelet·containerd) 구성요소"></p>
...
<p align="center"><img src="/assets/img/kubernetes-goat/diagram-3-kind-env.png" alt="실습 환경 — Docker Desktop(WSL2) 위에 kind가 노드 컨테이너를 띄우고, 포트포워딩으로 공격자가 접근"></p>
...
<p align="center"><img src="/assets/img/kubernetes-goat/01-goat-home.png" width="720" alt="Kubernetes Goat 홈"></p>
...
<p align="center"><img src="/assets/img/kubernetes-goat/diagram-4-attack-chain.png" alt="이번 실습에서 실제로 이은 공격 그래프 — 웹앱 발판에서 노드 탈출을 거쳐 클러스터 장악까지"></p>
...
<p align="center"><img src="/assets/img/kubernetes-goat/11-buildcode.png" width="720" alt="git 히스토리에서 AWS 키 복원"></p>
...
<p align="center"><img src="/assets/img/kubernetes-goat/07-rce-result.png" width="720" alt="커맨드 인젝션으로 root 명령 실행"></p>
...
<p align="center"><img src="/assets/img/kubernetes-goat/09-container-escape.png" width="760" alt="컨테이너 이스케이프 전체 체인"></p>
...
<p align="center"><img src="/assets/img/kubernetes-goat/08-ssrf-result.png" width="640" alt="SSRF로 내부 metadata 시크릿 획득"></p>
...
<p align="center"><img src="/assets/img/kubernetes-goat/10-registry.png" width="720" alt="비인증 레지스트리 이미지 ENV 시크릿"></p>
...
<p align="center"><img src="/assets/img/kubernetes-goat/12-rbac.png" width="720" alt="파드 SA 토큰으로 네임스페이스 Secret 탈취"></p>
